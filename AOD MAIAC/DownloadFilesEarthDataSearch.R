...
# I recommend this option, in order to carry it out you have to access the page of:
# https://search.earthdata.nasa.gov/
# If you want to download MAIAC AOD you need to search for the product MCD19A2 
# If you are in Cordoba Argentina, modis tiles are: h12v12
# Next you need to download the txt whith the product images you need, see txt_example.txt for an example file.

# Define the working directory where you have the file
setwd("C:/Users/marti/Desktop/SateliteFunctions/AOD MAIAC")

# Read the files
files <- readLines("txt_example.txt", warn = FALSE)
